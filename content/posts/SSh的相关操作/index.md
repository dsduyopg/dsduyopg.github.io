...
- [一.基于SSH实现发送命令到远程服务器](#SSH_3)

- [二.基于SSH进⾏免密数据传输](#SSH_54)

- [三.综合案例基于JDK的安装和操作](#JDK_94)


- [一.台机器的jdk的安装和配置](#jdk_98)

- [二.把这个软件和相应的配置文件通过scp发送出去](#scp_130)


- [四.基于Ubuntu完成SSH服务配置](#UbuntuSSH_153)


- [一.第⼀步： 需要让三个服务器全部都使⽤itheima⽤⼾登录服务器](#_itheima_157)

- [二.第二步: 需要让三台服务器都要配置免密操作](#___177)

- [三.第三步：依次通过： ssh 主机地址 连接各个服务器， 观察是否需要输⼊密码](#_ssh____217)
