...
- [2.顶级域DNS服务器(TLD DNS Servers)](#2DNSTLD_DNS_Servers_37)

- [3.权威DNS服务器（Authoritative DNS Servers）](#3DNSAuthoritative_DNS_Servers_59)


- [3.DNS服务器软件介绍](#3DNS_63)


- [二.在DNS服务器上安装BIND](#DNSBIND_121)

- [三.配置BIND主配置⽂件](#BIND_137)
