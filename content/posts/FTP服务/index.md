...
- [1.安装软件vsftp](#1vsftp_95)

- [2.启动并配置 vsftpd 服务](#2_vsftpd__103)

- [3. 配置防⽕墙](#3__113)

- [4.基本访问配置修改配置文件](#4_132)
...
- [2.创建⼀个普通⽤⼾⽤于后续访问FTP](#2FTP_258)

- [3.node1 客⼾端访问查看](#3node1__262)


- [五.禁锢在指定的数据⽬录中](#_279)


- [1.创建⼀个本地⽤⼾的数据⽬录](#1_281)

- [2.修改配置⽂件](#2_290)

- [3.创建⽤⼾， 指定⽤⼾的家⽬录为禁锢的数据⽬录下](#3__303)
