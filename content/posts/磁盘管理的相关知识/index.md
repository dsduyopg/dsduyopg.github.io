...
- [2.1 查看磁盘与分区信息](#21__25)


- [1. lsblk —— 查看块设备（推荐首选）](#1_lsblk___27)

- [2. fdisk —— 查看分区表](#2_fdisk___36)

- [3. parted —— 高级分区查看](#3_parted___43)

- [4. blkid —— 查看 UUID 和文件系统类型](#4_blkid___UUID__50)
...
- [1. fdisk —— MBR 分区（交互式）](#1_fdisk__MBR__69)

- [2. gdisk —— GPT 分区（交互式）](#2_gdisk__GPT__85)

- [3. parted —— 高级分区工具](#3_parted___95)
...
- [3. 找出占用空间最大的目录（实战排障）](#3__207)


- [2.6 LVM 逻辑卷管理](#26_LVM__220)
...
- [2.7 磁盘 I/O 性能排查](#27__IO__267)


- [1. iostat —— 磁盘 I/O 统计](#1_iostat___IO__269)

- [2. iotop —— 按进程查看 I/O](#2_iotop___IO_286)

- [3. 其他 I/O 排查工具](#3__IO__294)


- [2.8 磁盘故障排查](#28__303)


- [1. SMART 健康检测](#1_SMART__305)
...
- [2.9 SWAP 交换分区管理](#29_SWAP__342)


- [1. 查看 SWAP](#1__SWAP_344)

- [2. 创建 SWAP 分区](#2__SWAP__351)

- [3. 永久生效（写入 fstab）](#3__fstab_365)

- [4. 调整 SWAP 使用策略](#4__SWAP__374)


- [2.10 fstab 配置文件详解](#210_fstab__385)
...
- [2.使用parted命令开始分区操作](#2parted_455)
...
- [2.使用mkswap格式化分区](#2mkswap_500)

- [3.设置swapon启动交换分区](#3swapon_505)
