...
（如果 Codex 是你主要用的 AI 工具，这里提一句就行：）整个过程中我先后尝试了多种 AI 辅助工具，从最初的方案探索到最终的代码实现，AI 大幅降低了"把想法变成可运行系统"的门槛。但工具再强，提不出正确的问题、判不准方案的优劣，AI 也帮不上忙。
...
整套脚本和一键安装包我已经打包发到 Telegram 频道，感兴趣的朋友可以自取试用：https://t.me/blogdata_hub 
