...
这次项目带给我的收获，还是挺大的，从最初的构思，到如今项目已成，有一种成就感，其实当自己真正完成一个项目之后，才真正知道里面的种种艰险，虽然我是利用ai帮助我实现的脚本，以及封装，代码我都没有写，但是依旧不影响我把整个流程做下来，并持续运行，我只不过是个codex提了，需求，让他循着我的续修一点一点修改，到最后的完全使用，里面遇到了好多问题，各种冲突，各种矛盾处理方法，优先级判别，裁定锁，这些东西我接触的很少，虽然codex也可以做到，但是希望，以后有时间还是研究一下逻辑实现
